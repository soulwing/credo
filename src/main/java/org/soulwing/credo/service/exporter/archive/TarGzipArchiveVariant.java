 ...
 */
@ApplicationScoped
public class TarGzipArchiveVariant extends AbstractFormatVariant 
    implements PemArchiveVariant {

  private static final String ID = "TAR.GZ";
  ...
  public ArchiveBuilder newArchiveBuilder() {
    ArchiveBuilder builder = archiveBuilderFactory.newBuilder();
