...
@Named
@ConversationScoped
public class EditCredentialBean implements Serializable {
  ...
  @Inject
  protected EditCredentialService credentialService;
  
  @Inject
  protected DelegatingCredentialEditor<CredentialEditor> editor;
  ...
  public String createEditor() {
    ...
    try {
      editor.setDelegate(credentialService.editCredential(id));
      beginConversation();
      return null;
    }
  ...
  public String save() {
    try {
      ...
      credentialService.saveCredential(editor.getDelegate(), errors);
      endConversation();
