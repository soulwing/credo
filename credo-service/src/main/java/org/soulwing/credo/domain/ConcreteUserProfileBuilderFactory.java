...
/**
 * A concrete {@link UserProfileBuilderFactory} implementation.
 *
 * @author Carl Harris
 */
@ApplicationScoped
public class ConcreteUserProfileBuilderFactory
    implements UserProfileBuilderFactory {

  /**
   * {@inheritDoc}
   */
  @Override
  public UserProfileBuilder newProfileBuilder() {
