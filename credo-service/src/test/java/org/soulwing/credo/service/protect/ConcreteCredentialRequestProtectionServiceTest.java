 ...
 * @author Carl Harris
 */
public class ConcreteCredentialRequestProtectionServiceTest {
  ...
  private ConcreteCredentialRequestProtectionService service = 
      new ConcreteCredentialRequestProtectionService();
